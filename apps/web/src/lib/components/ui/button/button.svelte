<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			size: {
				default: "h-9 sm:h-8 gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
				...
				"icon-sm": "size-8 sm:size-7 rounded-[min(var(--radius-md),12px)] in-data-[slot=button-group]:rounded-lg",
				"icon-lg": "size-9",
			},
		},
		defaultVariants: {
